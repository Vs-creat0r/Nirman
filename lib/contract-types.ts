...
export const CONTRACT_TABLES = ["cost_comparison", "delivery_challan", "grn", "inventory", "logs", "material_request", "project_items", "projects", "purchase_order", "rfq", "sessions", "settings", "sites", "users", "vendors"] as const;
