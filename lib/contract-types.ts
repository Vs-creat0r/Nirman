...
export const CONTRACT_TABLES = ["agent_usage", "cost_comparison", "delivery_challan", "grn", "inventory", "logs", "material_request", "project_items", "projects", "purchase_order", "rfq", "rfq_quotes", "sessions", "settings", "sites", "stock_movements", "tc_templates", "users", "vendors"] as const;
