...
export const MATERIAL_REQUEST_OPEN_STATES: readonly MaterialRequestStatus[] = ["draft", "pending", "queried", "ready_for_cc", "routed_to_rfq", "routed_to_cc", "review_cc", "ready_for_po", "review_po", "pending_po", "delivery_processing"] as const;
...
export const MATERIAL_REQUEST_LOCKED_STATES: readonly MaterialRequestStatus[] = ["pending", "ready_for_cc", "routed_to_rfq", "routed_to_cc", "review_cc", "ready_for_po", "review_po", "pending_po"] as const;
...
> = {
  ...
  ready_for_cc: { label: "Approved / Ready for CC", variant: "default" },
  routed_to_rfq: { label: "Routed to RFQ", variant: "default" },
  routed_to_cc: { label: "Routed to CC", variant: "default" },
