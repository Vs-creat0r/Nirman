    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-[10px] text-muted-foreground mt-1">POs dispatch tracking and receipt confirmations</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold tracking-tight text-foreground">0</div>
            <p className="text-[10px] text-muted-foreground mt-1">Vendor quote requests currently active</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="border-dashed">
        <CardContent className="h-60 flex flex-col items-center justify-center text-center gap-3.5 p-6">
          ...
          <div>
            <CardTitle className="text-sm font-bold">Supply & Vendors Panel</CardTitle>
            <CardDescription className="text-xs max-w-sm mt-1 mx-auto">
              This dashboard is currently empty. In Phase 2, you will be able to issue RFQs, configure vendor profiles, and track delivery challans here.
            </CardDescription>
          </div>
        </CardContent>
      </Card>
