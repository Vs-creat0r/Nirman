...
const STATUS_CONFIG_MAP: Record<string, StatusConfig> = {
  ...
  routed_to_rfq: {
    ...
    dotClass: "bg-[--info]",
    textClass: "text-[--info]",
    description: "Material request routed to Request for Quotation flow.",
  },
  routed_to_cc: {
    variant: "processing",
    label: "Routed to CC",
    dotClass: "bg-[--info]",
    textClass: "text-[--info]",
    description: "Material request routed directly to Cost Comparison.",
  },
  open: {
    variant: "processing",
    label: "Open",
    ...
    textClass: "text-[--info]",
    pulse: true,
    description: "Document is open and accepting vendor submissions / active operations.",
  },
  closed: {
    variant: "draft",
    label: "Closed",
    ...
    textClass: "text-muted-foreground",
    description: "Bidding or operation period completed and closed.",
  },
  archived: {
    variant: "danger",
    label: "Archived",
    ...
    description: "Document archived and retired from active view.",
  },
  review_cc: {
    variant: "processing",
    label: "In Review (CC)",
